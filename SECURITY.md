...
The `cisco-mcpclient-app` maintainers take all security issues in the project
seriously. Thank you for improving the security of `cisco-mcpclient-app`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`cisco-mcpclient-app` leverages GitHub's private vulnerability reporting.
